...
export function CartRecoveryPanel({ trigger }: CartRecoveryPanelProps) {
  ...
  return (
    <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
      ...
      <DialogContent className="max-w-2xl max-h-[80vh] overflow-y-auto industrial-card metallic-texture">
        <DialogHeader>
          <DialogTitle className="flex items-center gap-2 engineering-font">
